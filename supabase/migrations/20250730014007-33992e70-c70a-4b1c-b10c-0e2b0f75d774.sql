-- Performance Optimization Migration (Sem VACUUM)
-- FASE 1: Criação de Índices Compostos Críticos
...
-- FASE 4: Configurar autovacuum otimizado para tabelas críticas
...
-- FASE 5: Criar função para limpeza automática de logs antigos
